...
public class MainActivity extends AppCompatActivity {
        ...
        unitType.setOnCheckedChangeListener(
                new RadioGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(RadioGroup radioGroup, int checkId) {
                        RadioButton checkedRadioButton = (RadioButton) findViewById(checkId);
    ...
    public void doConvert() {
        ...
        double result = convertUnit(radioButton.getText().toString(), textOri, textConv,
                Double.parseDouble(String.valueOf(inputTxt.getText())));
        String resultText;
